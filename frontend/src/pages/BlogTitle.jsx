...
const BlogTitle = () => {
  ...
  return (
    <div className='h-full overflow-y-scroll p-6 flex items-start flex-wrap text-slate-700'>
  {/* left col */}
...
<div className='mt-3 flex gap-3 flex-wrap sm:max-w-9/11'>
  {blogCategories.map((item) => (
    <span onClick={()=> setSelectedCategories(item)} 
    className={`text-xs px-4 py-1 border rounded-full cursor-pointer ${selectedCategories === item? 'bg-purple-50 text-purple-700':

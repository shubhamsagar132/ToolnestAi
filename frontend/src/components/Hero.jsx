...
return(
  ...
  <div className='text-center mb-6'>
    ...
    <span className='text-primary'></span> AI tools </h1>
<p className='mt-4 max-w-xs sm:max-w-lg 2xl:max-w-x1 mx-auto max-sm:text-xs text-gray-600'>Transform your content creation with our
...
your workflow.</p>
  ...
  <div className='flex flex-wrap justify-center gap-4 text-sm max-sm:text-xs'>
    ...
    <button className='bg-white px-10 py-3rounded-lg border border-gray-300 hover:scale-102 active:scale-95 transition cursor-pointer'>Watch demo</button>
  </div>

            ...
            <div className="flex flex-col md:flex-row justify-between w-full gap-10 border-b border-gray-500/30 pb-6">
                <div className="md:max-w-96">
                    ...
                    <p className="mt-6 text-sm">
                        Experience the power of AI with ToolnestAi. <br /> Transform your
...
articles, generate images, and enhance your workflow.
            ...
            <p className="pt-4 text-center text-xs md:text-sm pb-5">
                Copyright 2025 © <a href="https://my-portfolio-iota-three-29.vercel.app/"  className="text-gray-600 hover:text-primary active:text-primary transition-colors duration-200" >Shubham sagar</a>. All Right Reserved.
            </p>
        </footer>
    );
};
